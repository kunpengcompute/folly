...
|特性描述|更新说明|
|--|--|
|Folly io_uring混合读写优化|读操作使用io_uring multishot减少系统调用；写操作使用开源send保持连续写顺序，并通过PollWriteSqe侦听socket可写事件。|

## 版本配套文档

|文档名称|内容简介|交付形式|
|---|---|---|
|《[API参考](./api_reference.md)》|本文档提供Folly v1.1.0优化特性API使用说明|开源仓|
|《[快速入门](./quick_start.md)》|本文档提供编译Folly优化版本入门操作指导|开源仓|
|《[版本说明书](./release_notes.md)》|本文档提供Folly优化补丁版本发布信息|开源仓|
